...
console.log(createMenuItem("Chicken Wrap", 12.99, "Lunch"));
...
burger.discount = function (client) {
  if (client === "student" || client === "teacher") {
...
reviews.push({ name: "Rod", rating: 5, feedback: "Awesome services" });
console.log(reviews);
